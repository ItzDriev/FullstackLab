...
import { BookUser, KeyRound, Mail, User } from "lucide-react";
    ...
    <main className="flex justify-center items-center bg-(--navBG)/80 shadow-[0_4px_12px_rgba(0,0,0,0.25),0_12px_40px_rgba(0,0,0,0.45)] backdrop-blur-lg border border-red-500 w-1/4 min-h-3/4">
      ...
      <form className="mt-7 w-44/50 h-45/50">
        ...
        <div className="mt-7 text-white">
          <label htmlFor="name" className="block mb-1 font-light text-white">
            Full Name
          </label>
          <div className="flex items-center gap-3 pb-3 border-red-500 border-b">
            <BookUser className="text-[#94A3B8]" size={30} />
            <InputField
              id="name"
        ...
        <div className="mt-7 text-white">
          <label htmlFor="email" className="block mb-1 font-light text-white">
            Email
          </label>
          <div className="flex items-center gap-3 pb-3 border-red-500 border-b">
            <Mail className="text-[#94A3B8]" size={30} />
            <InputField
              id="email"
