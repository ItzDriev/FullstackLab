  ...
  return (
    <section className="flex flex-col w-full min-h-[calc(100vh-4rem)] overflow-x-hidden">
      ...
      <div className="z-10 relative flex flex-col justify-center items-center w-full text-white">
        <h1 className="mt-20 font-montserrat font-bold text-5xl">
          Available Sercives
        </h1>
        <section className="flex justify-center gap-15 w-full h-full">
          <article className="flex flex-col bg-(--mainBG)/70 w-[25%] min-h-[50vh] border-t-2 border-red-500 mt-10 transition-all duration-300 ease-out hover:-translate-y-4 hover:shadow-[0_0_25px_rgba(255,45,45,0.4)]">
          ...
          <article className="flex flex-col bg-(--mainBG)/70 w-[25%] h-[50vh] border-t-2 border-red-500 mt-10 transition-all duration-300 ease-out hover:-translate-y-4 hover:shadow-[0_0_25px_rgba(255,45,45,0.4)]">
            <div className="flex flex-col gap-4 p-4">
